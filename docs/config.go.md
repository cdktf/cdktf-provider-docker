...
```go
import "github.com/cdktf/cdktf-provider-docker-go/docker/v11/config"
...
| <code><a href="#@cdktf/provider-docker.config.ConfigConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/3.4.0/docs/resources/config#id Config#id}. |
