...
```go
import "github.com/cdktf/cdktf-provider-docker-go/docker/v12/plugin"
...
| <code><a href="#@cdktf/provider-docker.plugin.PluginConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/3.6.0/docs/resources/plugin#id Plugin#id}. |
