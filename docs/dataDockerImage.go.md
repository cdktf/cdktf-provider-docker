...
```go
import "github.com/cdktf/cdktf-provider-docker-go/docker/v12/datadockerimage"
...
| <code><a href="#@cdktf/provider-docker.dataDockerImage.DataDockerImageConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kreuzwerker/docker/3.6.0/docs/data-sources/image#id DataDockerImage#id}. |
