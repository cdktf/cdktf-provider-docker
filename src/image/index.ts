...
// https://registry.terraform.io/providers/kreuzwerker/docker/3.5.0/docs/resources/image
...
export class Image extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Image that should be imported. Refer to the {@link https://registry.terraform.io/providers/kreuzwerker/docker/3.5.0/docs/resources/image#import import section} in the documentation of this resource for the id to use
