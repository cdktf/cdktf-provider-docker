// https://registry.terraform.io/providers/kreuzwerker/docker/3.6.0/docs
...
export class DockerProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing DockerProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/kreuzwerker/docker/3.6.0/docs#import import section} in the documentation of this resource for the id to use
